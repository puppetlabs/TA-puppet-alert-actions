...
def process_event(helper, *args, **kwargs):
    ...
    puppet_user = helper.get_global_setting("puppet_user")
    helper.log_info("puppet_user={}".format(puppet_user))
    ...
    puppet_orch_server = helper.get_global_setting("puppet_orch_server")
    helper.log_info("puppet_orch_server={}".format(puppet_orch_server))
    ...
    puppet_user = helper.get_param("puppet_user")
    helper.log_info("puppet_user={}".format(puppet_user))

    pe_console = helper.get_param("pe_console")
    helper.log_info("pe_console={}".format(pe_console))

    puppet_orch_server = helper.get_param("puppet_orch_server")
    helper.log_info("puppet_orch_server={}".format(puppet_orch_server))
    ...
    # puppet_alt_user in the alert setup itself
